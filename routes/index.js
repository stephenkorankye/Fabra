...
//Checkout endpoint get
router.get('/checkout', isLoggedin,(req,res)=>{
    let error_message = req.flash('error_message')[0];
    if(!req.session.cart){
        req.flash('error_message',`Add some itmes first.`);
        res.redirect('/cart');
    }else{
        res.render('routes_UI/checkout', {user:req.user,totalPrice:req.session.totalPrice,error_message:error_message});
    }
})
...
router.post('/login',
 ...
 const products= [
                    ...
                    new Product({
                            imagePath: 'https://upload.wikimedia.org/wikipedia/en/7/7b/Personal_Computer.JPG',
                            title: 'Simple laptop',
                            description: 'Very nice simple laptop',
                            price: 200
                        }),
                        new Product({
                            imagePath: 'https://upload.wikimedia.org/wikipedia/en/7/7b/Personal_Computer.JPG',
